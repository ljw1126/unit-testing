...
namespace unit_testing.Chapter6.Listing4_6
{
    public class CustomerControllerTests
    {
        ...
        // 예저 6.6 값으로 비교하는 Comment ✨ (use Fluent Assertions)
        [Fact]
    ...
    public class Article
    {
        ...
        public IReadOnlyList<Comment> Comments =>
            _comments.ToList(); // ✅ 얕은 복사 (Shallow Copy)
    ...
    public class Comment
    {
        ...
        // 인스턴스 메서드 (Type-Safe Comparison, 타입 안전 비교)
