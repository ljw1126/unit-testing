...
namespace unit_testing.Chapter6.Listing7_.Functional3
{
    // 출력
    ...
    // 예제 6.13 AuditManager의 결정에 영향을 받는 가변 셀
    // 외부 객체
    ...
    // 예제 6.14 함수형 코어와 가변 셀 붙이기 (테스트x)
    public class ApplicationService
    {
        private readonly string _directoryName;
        private readonly AuditManager _auditManager; // 함수형 코어
        private readonly Persister _persister; // 가변 셀
